...
/*   Updated: 2025/10/06 20:44:29 by librahim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "AForm.hpp"

AForm::AForm() : name("default"),issigned(false) , g_tosign(150),  g_toex(150) {}
...
void     AForm::beSigned(Bureaucrat& b)
{
    ...
    {
        std::cout <<"dkheeeel: grade of bureaucrat " << b.getGrade()<< " and grade of form g_tosign"<< this->g_tosign << std::endl;
