...
/*   Updated: 2025/05/18 22:04:53 by librahim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap()
{
    std::cout << "A claptrap default constructor has been called" << std::endl;
    hit_points = 10;
    energy_points = 10;
    attack_damage = 0;
}
...
{
    std::cout << "Paramerized claptrap constructor has been called" << std::endl;
    name = n;
    hit_points = 10;
    energy_points = 10;
    attack_damage = 0;
...
ClapTrap::~ClapTrap()
{
    std::cout << "A claptrap Default destructor has been called" << std::endl;
}


ClapTrap::ClapTrap(const ClapTrap& obj)
{
    std::cout << " A claptrap Copy constructor has been called" << std::endl;
    name = obj.name;
...
{
    std::cout << " A claptrap copy assignement operator has been called" << std::endl;
    name = obj.name;
    hit_points = obj.hit_points;
    energy_points = obj.energy_points;
    attack_damage = obj.attack_damage;
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    if (this->energy_points == 0)
    {
        std::cout << "Repair action didnt work on claptrap " << name << " because there is not enough energy points." << std::endl;
        return ;
    }
